...
export default function ReviewSummary({ summary }: { summary: ReviewsSummary }) {
  ...
  if (totalReviews === 0) {
    return (
      <div className="border-y border-border bg-white p-5 text-center">
  ...
  return (
    <div className="grid grid-cols-1 gap-5 border-y border-border bg-white p-5 sm:grid-cols-[220px_1fr] sm:items-center sm:gap-8 sm:p-7">
