...
// Shared between the home page rail (UpcomingLaunches.tsx) and the
// /upcoming-cars "view all" page — countdown, estimated price, and a
// "Notify me" CTA instead of "View Details", since these cars don't have
// confirmed pricing/full specs yet.
export default function UpcomingCarCard({ car }: { car: HomeCar }) {
