...
export default function CompareHero({ h1Override }: { h1Override?: string | null }) {
  return (
    <div className="border-b border-border bg-surface">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:py-10">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-ink sm:text-[28px]">{h1Override || "All Car Comparisons"}</h1>
