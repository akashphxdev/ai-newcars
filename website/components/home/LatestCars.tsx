    ...
    <section className="bg-white py-12 sm:py-16">
      <div className="mx-auto max-w-7xl px-4">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="mb-1 text-xs font-bold uppercase tracking-widest text-red-600">Latest</p>
            <h2 className="text-2xl sm:text-3xl font-black text-gray-900">Latest cars in India</h2>
