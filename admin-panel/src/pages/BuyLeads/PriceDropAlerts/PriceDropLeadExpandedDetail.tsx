// src/pages/BuyLeads/PriceDropAlerts/PriceDropLeadExpandedDetail.tsx
//
...
export default function PriceDropLeadExpandedDetail({ lead }: { lead: PriceDropAlertLeadRecord }) {
  const { data: detail, isLoading, error: queryError } = useGetPriceDropAlertLeadByIdQuery(lead.id);
  const error = queryError ? "Couldn't load lead detail." : "";

  const [note, setNote] = useState("");
  const [addActivity, { isLoading: posting }] = useAddPriceDropAlertLeadActivityMutation();
