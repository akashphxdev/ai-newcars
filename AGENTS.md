...
## 6. Flag Issues in Previously Seen/Updated Code — Even While Working on Something Else
...
## 7. This Is a Production-Grade Project — Be Extra Careful
...
## 9. Bug Fixing & Better-Approach Discipline
...
## 13. Always Use the Proper Standard Approach (Not Just "A" Way)
...
## 14. Environment Variables & Secrets — Never Hardcode
...
## 15. Security Checks — Flag, Don't Silently Fix or Ignore
...
## 16. Performance Regression Check Before/After Changes
...
## 17. No Silent Breaking Changes to Existing Features
...
## 18. Git / Version Control Discipline (if applicable)
...
## 19. Logging & Error Handling Consistency
...
## 20. Comments — Only What's Truly Necessary
...
## 21. APIs — Fetch Only the Data That's Needed (No `SELECT *`, No Over-fetching)
